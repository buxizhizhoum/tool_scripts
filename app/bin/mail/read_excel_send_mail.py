...
def main():
    ...
    for index in range(0, data.shape[0]):
        ...
        mail_box = row[-1]
        content = make_table(columns, row)
        print content

        if mail_box and content:
            mail_sender.send_mail(mail_box, subject, content)
...
if __name__ == "__main__":
    mail_sender = MailSender(
        host="smtp.126.com",
        sender="bad_data_alarm@126.com",
        password="NewHupzon2017")
